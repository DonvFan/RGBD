...
from pl.dataset.preprocessing.preprocess_scannet import get_thing_semantics, get_classnames, visualize_mask_folder, \
    create_validation_set, map_panoptic_coco, mmdet_export_fixes
from pl.util.distinct_colors import DistinctColors
from pl.util.misc import create_box
from pl.util.transforms import hmg
...
if __name__ == "__main__":
    ...
    create_validation_set(dest, 0.2)
