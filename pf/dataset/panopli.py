...
from pf.dataset.base import create_segmentation_data_base, BaseDataset, process_bounding_box_dict
from pf.dataset.preprocessing.preprocess_scannet import get_thing_semantics
from pf.util.camera import compute_world2normscene
from pf.util.misc import EasyDict
from pf.util.ray import get_ray_directions_with_intrinsics, get_rays, rays_intersect_sphere
...
class PanopLiDataset(BaseDataset):
    ...
    def __init__(self, root_dir, split, image_dim, max_depth, overfit=False, num_val_samples=8, load_depth=False, load_feat=False, instance_dir='filtered_instance', semantics_dir="filtered_semantics",
                 instance_to_semantic_key='instance_to_semantic', create_seg_data_func=create_segmentation_data_base, subsample_frames=1, depth_scale= 1000.):
