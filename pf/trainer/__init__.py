...
from pf.util.misc import visualize_depth, probability_to_normalized_entropy, get_boundary_mask
from pf.util.warmup_scheduler import GradualWarmupScheduler
from pytorch_lightning import seed_everything, Trainer
from pytorch_lightning.callbacks import ModelCheckpoint
from pytorch_lightning.loggers import TensorBoardLogger, WandbLogger

from pf.util.filesystem_logger import FilesystemLogger
...
def visualize_panoptic_outputs(p_rgb, p_semantics, p_instances, p_depth, rgb, semantics, instances, H, W, thing_classes, visualize_entropy=True):
    ...
    if rgb is not None and semantics is not None and instances is not None:
        ...
        colored_img_instance_gt[instances == 0, :] = rgb.cpu()[instances.cpu() == 0, :]
