...
from pl.util.camera import compute_world2normscene, unproject_2d_3d
from pl.util.distinct_colors import DistinctColors
from pl.util.misc import visualize_points, EasyDict, create_box, visualize_cameras, visualize_points_as_pts
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            ...
            sample = {
                ...
                "mask": mask,
                "depth": depth,
                "intrinsics":self.intrinsics[sample_idx],
                "cam2world": self.cam2normscene[sample_idx]
            }
        return sample
